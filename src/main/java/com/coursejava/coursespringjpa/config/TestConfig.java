...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        order1.setClient(u1);
        order1.setMoment(Instant.parse("2025-12-15T12:44:00Z"));

        Order order2 = new Order();
        order2.setClient(u2);
        order2.setMoment(Instant.parse("2025-12-15T12:47:00Z"));

        Order order3 = new Order();
        order3.setClient(u1);
        order3.setMoment(Instant.parse("2025-12-15T12:48:00Z"));
